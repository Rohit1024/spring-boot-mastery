...
# 0057: Monolith vs Microservices: System Design Principles & Service Boundaries
...
### 3. Conway's Law & Two-Pizza Teams
...
| :--- | :---: | ---: |
| [⬅️ **0056: Rate Limiting Algorithms in Redis**](0056-redis-rate-limiting-algorithms.md) | [**All Lessons**](index.md) | [➡️ **0058: Inter-Service Communication: Feign, WebClient & RestTemplate**](0058-interservice-communication-feign-webclient.md) |
